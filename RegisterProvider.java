...
/**
 * Usage:
 * java com.vmware.samples.sms.RegisterProvider --url [webserviceurl]
...
public class RegisterProvider {
   ...
   public RegisterProvider(SmServiceConnection conn, VasaProviderSpec spec) throws Exception {
      this.conn = conn;
      this.spec = spec;
   ...
   private static void printUsage() {
      ...
      System.out.println("\nCommand:");
      System.out.println("run[.bat|.sh] com.vmware.samples.sms.RegisterProvider --url [webserviceurl]");
   ...
   public static void main(String[] args) throws Exception {
      ...
      RegisterProvider prov = new RegisterProvider(conn, spec);
